...
/**
 * Declares the tool set for the DocumentationAssistant.
 *
 ...
 */
public class DocumentationAssistantTools
{
	public static Map<ToolSpecification, ToolExecutor> getTools()
	{
		return ToolComposer.from(
			...
			IGetCurrentSelectionTool.class,
			IGetDocumentationForIdentifiersTool.class,
			IApplyDocumentationsTool.class,
			IGetAvailableMembersForTypeTool.class,
			IGetDocumentationForTypeMemberTool.class,
