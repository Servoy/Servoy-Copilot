...
import com.servoy.eclipse.servoypilot.tools.testgeneration.IAddTestMethodTool;
...
/**
 * Declares the tool set for the UnitTestAssistant.
 *
 ...
 */
public class UnitTestAssistantTools
{
	public static Map<ToolSpecification, ToolExecutor> getTools()
	{
		return ToolComposer.from(
			...
			// Test generation
			IAnalyzeCodeForTestingTool.class,
