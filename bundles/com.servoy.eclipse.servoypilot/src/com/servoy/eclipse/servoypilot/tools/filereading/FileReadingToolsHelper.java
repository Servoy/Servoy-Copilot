...
/**
 * Singleton helper providing shared logic for file reading tool interfaces.
 * Holds the LRU cache, file resolution, JSON building, and line reading utilities.
 */
public class FileReadingToolsHelper
{
	...
	private static final FileReadingToolsHelper INSTANCE = new FileReadingToolsHelper();
	...
	private FileReadingToolsHelper()
	{
	}

	public static FileReadingToolsHelper getInstance()
	{
		return INSTANCE;
	}
