...
/**
 * Layer 1 unit tests for the private static {@code extractFunctionName} helper
 * in {@link IAnalyzeCodeForTestingTool}.
 * <p>
 * This is pure string parsing logic: scan for {@code "function "}, extract the
 * identifier up to the first {@code (}.
 */
public class AnalyzeCodeToolTest
{
	...
	{
		extractFunctionName = IAnalyzeCodeForTestingTool.class.getDeclaredMethod("extractFunctionName",
			String.class);
	...
	public void testExtractFunctionName_withLeadingWhitespace() throws Exception
	{
		...
		// "function " is found at index 3; name starts after that, up to "("
		// "  spaced  " trimmed = "spaced"
		assertEquals("spaced", result.trim());
	}
