...
public final class CypressTestSessionManager {
	...
	public synchronized void updateResult(String testName, CypressTestResult result) {
		...
		// Update the active history entry with current snapshot
	...
	public synchronized void stop() {
		...
		// Mark remaining PENDING/RUNNING tests so history doesn't show [running]
	...
	public synchronized void restoreFromHistory(HistoryEntry entry) {
		...
		running = false;
		// Viewing a historical run - don't keep updating the active entry
