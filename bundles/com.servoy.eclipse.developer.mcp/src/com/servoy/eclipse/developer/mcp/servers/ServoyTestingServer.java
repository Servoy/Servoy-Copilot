...
public class ServoyTestingServer {
	...
	@Tool(name = "screenshotForm", description = "Takes a screenshot of a specific Servoy form rendered in a headless browser. "
			...
			+ "Use this to visually verify form layout, check element positioning, or capture the current state of a form.", type = "object")
	...
	@Tool(name = "testForm", description = "Runs Cypress-based spec tests against a Servoy form in a headless browser. "
	...
	@Tool(name = "generateFormSpec", description = "Generates Cypress test spec files for a Servoy form. "
